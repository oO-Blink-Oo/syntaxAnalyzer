...
struct tokenType {
	string token; // this prints out the actual lexeme character such as int, a, double, cat
	int lexeme;
	string lexemeName;  // token name for the lexeme such as KEYWORD, IDENTIFIER, etc
